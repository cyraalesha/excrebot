...
def process_file(filepath):
    ...
    if prediction.item(0) > PREDICTION_THRESHOLD:
      ...
      return "Your poop is {}% Type 1!".format(prediction_text)
    if prediction.item(1) > PREDICTION_THRESHOLD:
      prediction_text = truncate(prediction.item(1)*100, 2)
      return "Your poop is {}% Type 2!".format(prediction_text)
    else:
      prediction_text = truncate(prediction.item(2)*100, 2)
      return "Your poop is {}% Type 4!".format(prediction_text)
